...
class IEGMNet(nn.Module):
    def __init__(self):
        ...
        self.adaptive_pool = nn.AdaptiveAvgPool2d((37, 1))  # Adjust the output size as needed
        self.fc1 = nn.Sequential(
            nn.Dropout(0.5),
            nn.Linear(in_features=20*37, out_features=10)  # 20 is the number of channels from conv5
        )
    ...
    def forward(self, input):
        ...
        pooled_output = self.adaptive_pool(conv5_output)
